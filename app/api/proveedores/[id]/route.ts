  ...
  try {
    ...
    const proveedor = await prisma.proveedor.update({
      ...
      data: {
        ...
        ...(validatedData.contactoPrincipal !== undefined && { contactoPrincipal: validatedData.contactoPrincipal }),
        ...
        ...(validatedData.sitioWeb !== undefined && { sitioWeb: validatedData.sitioWeb || undefined }),
        ...(validatedData.categoriaProductos !== undefined && { categoriaProductos: validatedData.categoriaProductos }),
        ...(validatedData.tiempoEntregaDias !== undefined && { tiempoEntregaDias: validatedData.tiempoEntregaDias }),
        ...(validatedData.monedaPreferida !== undefined && { monedaPreferida: validatedData.monedaPreferida }),
        ...(validatedData.terminosPago !== undefined && { terminosPago: validatedData.terminosPago }),
        ...
        ...(validatedData.calificacion !== undefined && { calificacion: validatedData.calificacion }),
