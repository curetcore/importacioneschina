...
export default function Sidebar() {
  ...
  return (
    <aside className="sticky top-16 h-[calc(100vh-4rem)] w-60 bg-white border-r border-shopify-border-subdued overflow-y-auto z-40 flex flex-col rounded-tl-3xl flex-shrink-0">
      {/* Main menu items */}
