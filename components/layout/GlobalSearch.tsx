    ...
    <div ref={searchRef} className="relative w-full">
      ...
      <div className="relative">
        ...
        <input
          ...
          className="w-full pl-10 pr-10 py-2 border-0 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 bg-shopify-navbar-search text-white placeholder-gray-400"
        />
        {query && (
          <button
            onClick={handleClear}
